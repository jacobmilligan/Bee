...
*/
#if !defined(BEE_CONFIG_TEMP_ALLOCATOR_FRAME_COUNT)
    #define BEE_CONFIG_TEMP_ALLOCATOR_FRAME_COUNT 4
#endif // BEE_CONFIG_TEMP_ALLOCATOR_FRAME_COUNT

#if !defined(BEE_CONFIG_TEMP_ALLOCATOR_MAX_THREADS)
    #define BEE_CONFIG_TEMP_ALLOCATOR_MAX_THREADS 64
#endif // BEE_CONFIG_TEMP_ALLOCATOR_MAX_THREADS

#if !defined(BEE_CONFIG_DEFAULT_TEMP_ALLOCATOR_SIZE)
    #define BEE_CONFIG_DEFAULT_TEMP_ALLOCATOR_SIZE 4 * 1024 * 1024 // 4MB per frame
...
#ifdef __cplusplus
    #define BEE_PAD(N) BEE_REFLECT(ignored) char BEE_CONCAT(padding, __LINE__)[N] { 0 }
#else
 ...
 */
#ifndef BEE_CONFIG_VULKAN_BACKEND
    #define BEE_CONFIG_VULKAN_BACKEND 0
#endif // BEE_CONFIG_VULKAN_BACKEND

#ifndef BEE_CONFIG_METAL_BACKEND
 ...
 */
#define BEE_FORWARD(...) static_cast<decltype(__VA_ARGS__)&&>(__VA_ARGS__)
