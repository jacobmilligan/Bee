...
#define IM_ASSERT(_EXPR)  BEE_ASSERT(_EXPR) // already disables asserts in release builds
...
#define IM_VEC4_CLASS_EXTRA                                                     \
        ...
        operator bee::float4() const { return bee::float4(x,y,z,w); }
...
#define IM_DEBUG_BREAK BEE_DEBUG_BREAK
