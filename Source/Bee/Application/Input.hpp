...
BEE_API bool is_key_down(const InputBuffer& buffer, Key key);

BEE_API bool is_key_up(const InputBuffer& buffer, Key key);

BEE_API bool is_key_typed(const InputBuffer& buffer, Key key);
