...
pushd ..\..\ThirdParty\cimgui\generator
...
set PATH=%PATH%;..\..\Binaries\LuaJIT\bin\mingw64
...
if "%USER_CONFIG%" == "" (
    luajit ./generator.lua %COMPILER% "%INTERNAL%"
) else (
    luajit ./generator.lua %COMPILER% "%INTERNAL%" -DIMGUI_USER_CONFIG=%USER_CONFIG%
)
